 ...
 * @author Alex Wezensky
 */
int* writefile::make2(int noframes){
    int* fdur = new int[noframes];
    //qDebug() << noframes;
 ...
 * @author Alex Wezensky
 */
int *writefile::populate2(int duration, int * fdur, int framenumber){
 ...
 * @author Alex Wezensky
 */
void writefile::write(QString nameoffile, int** write, int noframes, int *fdurfilled){
    //QList<Pixel *> pList = frame->getTowerContents();
    //qDebug() << pList;
