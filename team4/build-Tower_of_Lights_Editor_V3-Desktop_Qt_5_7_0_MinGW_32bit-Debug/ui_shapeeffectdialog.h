...
"border-radius: 4px;"));
    ...
    {
        shapeEffectDialog->setWindowTitle(QApplication::translate("shapeEffectDialog", "Dialog", 0));
        pushButton_left->setText(QApplication::translate("shapeEffectDialog", "Left", 0));
        pushButton_up->setText(QApplication::translate("shapeEffectDialog", "Up", 0));
        pushButton_down->setText(QApplication::translate("shapeEffectDialog", "Down", 0));
        pushButton_right->setText(QApplication::translate("shapeEffectDialog", "Right", 0));
        noFill->setText(QApplication::translate("shapeEffectDialog", "No Fill", 0));
        pushButton_color_2->setText(QApplication::translate("shapeEffectDialog", "#ffffff", 0));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("shapeEffectDialog", "Select a shape", 0)
         << QApplication::translate("shapeEffectDialog", "Circle", 0)
         << QApplication::translate("shapeEffectDialog", "Square", 0)
         << QApplication::translate("shapeEffectDialog", "Vertical Rectangle", 0)
         << QApplication::translate("shapeEffectDialog", "Horizontal Rectangle", 0)
         << QApplication::translate("shapeEffectDialog", "L-Shape", 0)
         << QApplication::translate("shapeEffectDialog", "Mirrored L-Shape", 0)
         << QApplication::translate("shapeEffectDialog", "S-Shape", 0)
         << QApplication::translate("shapeEffectDialog", "Z-Shape", 0)
         << QApplication::translate("shapeEffectDialog", "T-Shape", 0)
         << QApplication::translate("shapeEffectDialog", "Box", 0)
         << QApplication::translate("shapeEffectDialog", "Line", 0)
        );
        pushButton_color->setText(QApplication::translate("shapeEffectDialog", "#ffffff", 0));
        label_3->setText(QApplication::translate("shapeEffectDialog", "Border Color:", 0));
        label_2->setText(QApplication::translate("shapeEffectDialog", "Fill Color:", 0));
        pushButton_clear->setText(QApplication::translate("shapeEffectDialog", "Clear", 0));
    } // retranslateUi
