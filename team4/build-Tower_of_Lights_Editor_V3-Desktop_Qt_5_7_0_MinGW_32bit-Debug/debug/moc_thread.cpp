...
#include "../../Tower_of_Lights_Editor_V3/thread.h"
...
QT_MOC_LITERAL(1, 9, 13), // "countdownDone"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "myThread\0countdownDone\0"
};
...
void myThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myThread::countdownDone)) {
                *result = 0;
                return;
            }
        }
