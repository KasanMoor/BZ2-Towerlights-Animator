...
#include "../../TowerLightsAnimator/cell.h"
...
void CellWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellWidget::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellWidget::clicked)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellWidget::doubleClicked)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CellWidget::selected)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject CellWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CellWidget.data,
      qt_meta_data_CellWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void Thumbnail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thumbnail::clicked)) {
                *result = 0;
                return;
            }
        }
...
void interactableArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&interactableArea::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject interactableArea::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_interactableArea.data,
      qt_meta_data_interactableArea,  qt_static_metacall, nullptr, nullptr}
};
