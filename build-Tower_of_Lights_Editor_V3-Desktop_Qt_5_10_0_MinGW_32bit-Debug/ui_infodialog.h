...
public:
    ...
    void retranslateUi(QDialog *infoDialog)
    {
        ...
        pushButton_close->setText(QApplication::translate("infoDialog", "Close", nullptr));
...
"\n"
"-A blank frame is appended to files if the last frame in the project is not a blank frame. This is so that the player does not cut off the last frame upon display", nullptr));
    } // retranslateUi
